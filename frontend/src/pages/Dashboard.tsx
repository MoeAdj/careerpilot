...
export default function Dashboard() {
  const user = JSON.parse(localStorage.getItem('careerpilot_user') || '{}');
    ...
    <div className="flex min-h-screen flex-col md:flex-row">
      ...
      <main className="flex-1 px-4 py-4 pb-24 md:px-8 md:py-8">
        <section className="mb-8 overflow-hidden rounded-3xl border border-slate-800 bg-gradient-to-r from-blue-600/20 via-slate-900 to-slate-900 p-4 md:p-8">
          ...
          <h1 className="mt-3 text-2xl font-extrabold sm:text-3xl md:text-5xl">
            Welcome back,
            <br />
            {user.name || 'Student'} 👋
          </h1>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <textarea
                  ...
                  placeholder="Notes"
                  className="min-h-24 w-full rounded-xl p-3"
                />

                <button className="w-full rounded-xl bg-blue-500 py-3 font-semibold hover:bg-blue-400">
                  Save application
                </button>
              </div>
            </form>
            ...
            <div className="rounded-3xl border border-slate-700 bg-slate-900 p-6">
              ...
              <p className="mb-3 text-sm text-slate-400">
                Upload your resume and compare it against a job description to identify missing skills and improve your chances of landing interviews.
              </p>
              ...
              <button
                onClick={checkResume}
                className="mt-3 w-full rounded-xl bg-emerald-500 py-3 font-semibold hover:bg-emerald-400"
              >
                Check resume
              </button>
              <button
